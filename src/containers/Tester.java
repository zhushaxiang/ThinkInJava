...
public class Tester<C> {
	...
	public static void main(String[] args) {
		...
		List<Integer> lists2 = new ArrayList<Integer>(lists);
		List<String> lists3 = Arrays.asList(new String[]{"3","2","3","1"});
		System.out.println(lists);
		Collections.shuffle(lists);
		System.out.println(lists);
		System.out.println(lists2);
		Collections.sort(lists3, String.CASE_INSENSITIVE_ORDER);
